...
pub use self::module::*;
use self::system_info::{GetSystemInfo, GetSystemMetadata, GetSystemResources};
...
impl ManagementService {
        ...
        <M::AuthenticateFuture as Future>::Error: Fail,
    {
        let router = router!(
            ...
            get     Version2019_11_05 runtime Policy::Module(&*AGENT_NAME)  => "/systeminfo/metadata"               => GetSystemMetadata::new(runtime.clone()),
